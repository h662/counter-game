...
const CounterGameFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_countergame_free(ptr >>> 0, 1));
...
export class CounterGame {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        CounterGameFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_countergame_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.countergame_new();
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        CounterGameFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    draw() {
        wasm.countergame_draw(this.__wbg_ptr);
    }
    increment() {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('counter_game_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
